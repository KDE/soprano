...
namespace Soprano {
    namespace Util {
        class SimpleTransactionFactory : public Soprano::TransactionFactory
        {
        public:
            SimpleTransactionFactory( SimpleTransactionModelPrivate* p )
                : d( p ) {
            }

            Soprano::Transaction* startTransaction() {
        ...
        private:
            SimpleTransactionModelPrivate* d;
        };
    }
}
...
{
    d->model = this;
    setTransactionFactory( new SimpleTransactionFactory( d ) );
}
