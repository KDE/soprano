...
namespace Soprano {
	...
	const quint16 COMMAND_ITERATOR_CURRENT_STATEMENT = 0x11; /**< Works for both statement and query its. */
	const quint16 COMMAND_ITERATOR_CURRENT_NODE = 0x12;
	const quint16 COMMAND_ITERATOR_CURRENT_BINDINGSET = 0x13;
	const quint16 COMMAND_ITERATOR_CLOSE = 0x14;
	const quint16 COMMAND_ITERATOR_QUERY_TYPE = 0x15;
	const quint16 COMMAND_ITERATOR_QUERY_BOOL_VALUE = 0x16;
	const quint16 COMMAND_SUPPORTED_FEATURES = 0x17;
	const quint16 COMMAND_SUPPORTS_PROTOCOL_VERSION = 0x18;
    }
}
