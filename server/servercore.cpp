...
public:
    ...
    BackendSettings createBackendSettings( const QString& name ) {
        ...
        if ( newSettings.hasOption( BackendOptionStorageDir ) ) {
            BackendSetting& setting = newSettings.setting( BackendOptionStorageDir );
...
Soprano::Model* Soprano::Server::ServerCore::model( const QString& name )
{
    ...
    if ( it == d->models.constEnd() ) {
        ...
        if ( settings.hasOption( BackendOptionStorageDir ) ) {
            QDir().mkpath( settings.value( BackendOptionStorageDir ).toString() );
        }
...
Soprano::Model* Soprano::Server::ServerCore::createModel( const BackendSettings& settings ) const
{
