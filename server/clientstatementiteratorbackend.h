...
namespace Soprano 
{
    ...
    namespace Client {
        ...
        class ClientStatementIteratorBackend : public Soprano::IteratorBackend<Statement>, public ClientIteratorBase
        {
        public:
            ClientStatementIteratorBackend( int itId, const ClientModelBase* model );
