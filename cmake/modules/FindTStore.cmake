...
if (TSTORE_LIBRARIES AND TSTORE_INCLUDE_DIR AND TSTORE_CFLAGS)
  ...
  if (TStore_FIND_REQUIRED)
    set (TStore_REQUIRED "REQUIRED")
  else (TStore_FIND_REQUIRED)
    set (TStore_REQUIRED "")
  endif (TStore_FIND_REQUIRED)
  
  find_package(GLIB2 ${TStore_REQUIRED})
  find_package(MySQL ${TStore_REQUIRED})

  set(TSTORE_CFLAGS "${GLIB2_CFLAGS} -I${GLIB2_INCLUDE_DIR} -I${MYSQL_INCLUDE_DIR}")
  ...
  if (TSTORE_LIBRARIES AND TSTORE_INCLUDE_DIR AND GLIB2_FOUND AND MySQL_FOUND)
     set(TSTORE_FOUND TRUE)
  endif (TSTORE_LIBRARIES AND TSTORE_INCLUDE_DIR AND GLIB2_FOUND AND MySQL_FOUND)
